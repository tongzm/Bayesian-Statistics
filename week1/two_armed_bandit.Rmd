...
data1 = data.frame(machine = c(rep(1, 10)), 
                   outcome = c("W", "W", "L", "L", "W", "L", "W", "L", "L", "L"))
data1 = data.frame(machine = c(rep(1, 10)), 
                   outcome = c("W", "W", "L", "L", "W", "L", "W", "L", "L", "L"))
...
data1 = data.frame(machine = c(rep(1, 25)), 
                   outcome = c("L", "L", "L", "L", "W", "W", "W", "L", "W", "L",
                               "L", "L", "L", "W", "L", "L", "L", "L", "W", "L",
                               "W", "W", "L", "W", "L"))
data2 = data.frame(machine = c(rep(1, 25)), 
                   outcome = c("L", "W", "W", "L", "W", "W", "L", "L", "L", "L",
                               "L", "L", "L", "W", "L", "L", "L", "L", "W", "L",
                               "L", "W", "W", "L", "L"))
...
<div class="exercise">
Plot the result of your last 50 plays using the code `plot_bandit_posterior(data)` as shown in the example above, desribe the pattern you see for the two posterior probabilities.
</div>

```{r E6}
# Type your code for Exercise 6 here
data = data.frame(machine = c(rep(1, 25),rep(1, 25)), 
                   outcome = c("L", "L", "L", "L", "W", "W", "W", "L", "W", "L",
                               "L", "L", "L", "W", "L", "L", "L", "L", "W", "L",
                               "W", "W", "L", "W", "L",
                               "L", "W", "W", "L", "W", "W", "L", "L", "L", "L",
